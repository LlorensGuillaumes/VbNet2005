...
Public Class InformeRecoNoConforme
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InformeRecoNoConforme.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeRecoNoConforme
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeRecoNoConforme = New InformeRecoNoConforme
        rpt.Site = Me.Site
        Return rpt
    End Function
