...
Public Class InformeFactures
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SubInformeFacturarpt_Pm_FacturesNumFactura() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInformeFactures
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeFactures = New InformeFactures
        rpt.Site = Me.Site
        Return rpt
    End Function
