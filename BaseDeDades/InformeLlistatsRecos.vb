...
Public Class InformeLlistatsRecos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InformeLlistatsRecos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeLlistatsRecos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeLlistatsRecos = New InformeLlistatsRecos
        rpt.Site = Me.Site
        Return rpt
    End Function
